export default function ShoppingBagNew() {
  return (
    <div className="flex flex-row justify-center flex-nowrap cursor-pointer">
      ...
      <span className=" ml-1 text-13px font-normal self-center whitespace-nowrap .1380:text-10px">
        ₽ 22323.00
      </span>
    </div>
  );
